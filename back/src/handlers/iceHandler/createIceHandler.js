...
const createIceHandler = async (req, res) => {
    try {
        const {name_ice, price_ice, about_ice, img_ice, category,type_ice} = req.body
        const response = await createIceController(name_ice, price_ice, about_ice, img_ice, category,type_ice)
